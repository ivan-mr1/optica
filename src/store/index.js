...
const cards = document.querySelector('[data-products-catalog]');
...
function checkingActiveButtons(basket) {
  ...
  buttons.forEach((btn) => {
    ...
    btn.textContent = isInBasket ? 'У кошику' : 'У кошик';
  });
}
    ...
    const cardItem = `
      <div class="card" data-product-id="${id}">
          ...
          <div class="card__bottom">
              ...
              <a href="/card.html?id=${id}" class="card__title">${model}</a>
              <button class="card__add">У кошик</button>
          </div>
      </div>
    `;
